package com.bapas.agent.utility.imagepicker
...
import com.bapas.agent.utility.imagepicker.constant.ImageProvider
import com.bapas.agent.utility.imagepicker.provider.CameraProvider
import com.bapas.agent.utility.imagepicker.provider.CompressionProvider
import com.bapas.agent.utility.imagepicker.provider.CropProvider
import com.bapas.agent.utility.imagepicker.provider.GalleryProvider
import com.bapas.agent.utility.imagepicker.util.FileUriUtils
...
class ImagePickerActivity : AppCompatActivity() {
    ...
    private fun loadBundle(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(ImagePicker.EXTRA_POS)) {
            pos = intent.extras!![ImagePicker.EXTRA_POS].toString().toInt()
        ...
        when (provider) {
            ...
            ImageProvider.CAMERA -> {
                ...
                Logger.e("Image provider can not be null")
    ...
    private fun setResult(uri: Uri) {
        ...
        intent.putExtra(ImagePicker.EXTRA_POS, pos)

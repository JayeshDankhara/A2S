...
fun Context.showDialog(
    ...
    builder.setPositiveButton(positiveText) { dialog, which ->
        ActAgentBase.dialogShowing = false
    ...
    ActAgentBase.dialogShowing = true
}
...
/**
 * create RequestMultiPart to string
 */
fun createMultiPartFromString(partString: String): RequestBody {
    return RequestBody.create(MultipartBody.FORM, partString)
}
/**
 * create RequestBody to string
 */
...
fun amountWithCurrency(amount: String?): String {
    return "${checkStringValue(amount, "0.0")} INR"
}
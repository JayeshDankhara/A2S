...
import com.bapas.agent.utility.imagepicker.listener.DismissListener
import com.bapas.agent.utility.imagepicker.listener.ResultListener
import com.bapas.agent.utility.imagepicker.util.DialogHelper
import java.io.File
...
open class ImagePicker {
    ...
    companion object {
        ...
        internal const val EXTRA_POS = "extra.pos"
    ...
    class Builder(private val activity: Activity) {
        ...
        fun setPosition(pos1: Int): Builder {
            this.pos = pos1
            return this
        }
